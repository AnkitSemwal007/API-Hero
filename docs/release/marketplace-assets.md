# Marketplace assets — 0.2.1

Guidance for listing media for **API Hero 0.2.1**. Full-resolution artwork under `docs/marketplace/` is typically `.vscodeignore`d; ship icons from `images/`.
...
- [ ] Screenshots reflect 0.2.1 features only
